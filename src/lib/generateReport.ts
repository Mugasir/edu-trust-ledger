...
export async function generateEduTrackReport(
  ...
  doc.text("EduCoreTrack Uganda", 20, 18);
  doc.setFontSize(10);
  doc.setFont("helvetica", "normal");
  doc.text("Verified Academic Report", 20, 26);
  doc.setFontSize(8);
  doc.text("Ministry of Education & Sports — Verified Platform", 20, 33);
  ...
  doc.setFontSize(8);
  doc.setTextColor(120, 120, 120);
  doc.text("This report was generated by EduCoreTrack Uganda.", 20, y);
  y += 5;
  ...
  doc.save(`EduCoreTrack_Report_${learner.id}.pdf`);
}
